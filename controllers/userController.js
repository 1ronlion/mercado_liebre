...
const usersController = {
	...
	loginProcess: (req, res) => {
		...
		if (!resultValidation.errors.length > 0){ 
			...
			console.log("🚀 ~ file: userController.js ~ line 64 ~ resultValidation", resultValidation)
			console.log("🚀 ~ file: userController.js ~ line 68 ~ resultValidation.errors", resultValidation.errors)
